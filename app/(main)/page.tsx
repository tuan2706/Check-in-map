...
export default function HomePage() {
  ...
  return (
    <main className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-x-4 top-4 z-20 flex flex-col gap-2 sm:inset-x-6 sm:top-6 lg:left-6 lg:right-auto lg:w-[420px]">
        <SearchBar value={query} onChange={setQuery} onFilterClick={() => {}} />
      </div>

      {passingBy.result && (
        <div className="absolute inset-x-0 top-16 z-20 sm:top-20 lg:left-6 lg:right-auto lg:w-[420px] lg:top-24">
          <PassingByBanner
